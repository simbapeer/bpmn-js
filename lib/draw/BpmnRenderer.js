...
var renderLabelWithForeignObject = require('../util/ForeignObjectUtil').renderLabel;
...
function BpmnRenderer(eventBus, styles, pathMap, canvas, priority) {
  ...
  function renderLabel(parentGfx, text, options) {
    var label = renderLabelWithForeignObject(parentGfx, text, options);
  ...
  function renderEmbeddedLabel(parentGfx, element, options) {
    ...
    return renderLabel(parentGfx, businessObject.name, merge({
      horizontalPosition: 'center',
      verticalPosition: 'center',
      style: {
        color: getStrokeColor(element),
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:StartEvent': function(parentGfx, element) {
      ...
      if (!businessObject.isInterrupting) {
        attrs = {
          strokeDasharray: '6',
          strokeLinecap: 'round'
        };
    ...
    'bpmn:SubProcess': function(parentGfx, element, attrs) {
      ...
      renderEmbeddedLabel(parentGfx, element, {
        verticalPosition: expanded ? 'top' : 'center'
      });
    ...
    'bpmn:EventBasedGateway': function(parentGfx, element) {
      ...
      var type = businessObject.eventGatewayType;
      var instantiate = !!businessObject.instantiate;
    ...
    'bpmn:Association': function(parentGfx, element, attrs) {
      ...
      if (businessObject.associationDirection === 'One' ||
          businessObject.associationDirection === 'Both') {
        attrs.markerEnd = marker('association-end', fill, stroke);
      }

      if (businessObject.associationDirection === 'Both') {
    ...
    'bpmn:DataObject': function(parentGfx, element) {
      ...
      if (isCollection(businessObject)) {
    ...
    'bpmn:BoundaryEvent': function(parentGfx, element) {
      ...
      var businessObject = getBusinessObject(element),
          cancel = businessObject.cancelActivity;
...
/**
 * Checks if eventDefinition of the given element matches with businessObject type.
 *
 * @return {boolean} true if element is of the given businessObject type
 */
